  ...
  return (
    function bar(svg, down, d, selector) {
      const g = svg.insert("g", selector)
        ...
        .style("font-family", "\"Noto Sans TC\", \"Helvetica Neue\", Arial, sans-serif")
        .style("font-size", "var(--bar-label-size)");
...
function _up(duration, x, d3, xAxis, stagger, stack, color, bar, down, barStep) {
  return (
    function up(svg, d) {
...
function _data(FileAttachment, buildHierarchy) {
  return (
